        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function money(n) {
	            ...
	            async function refreshBpUI(tr, q = '') {
	                ...
	                if (lockLines) {
	                    if (bpReadonly) {
	                        bpReadonly.textContent = current ? current : '-';
            ...
            function computeTotals() {
	            ...
	            function validateRows() {
	                ...
	                rows.forEach((tr, idx) => {
	                    ...
	                    if (!lockLines && accountId && needsBp && !bpId) errs.push(`Line #${i}: BP wajib dipilih untuk account ini.`);
	                ...
	                tr.innerHTML = `
	                    ...
	                    <td class="p-3">
	                        <div class="bpBox hidden">
	                            ...
	                            <div class="bpReadonly hidden text-xs text-gray-500 font-mono mt-1"></div>
	                        </div>
